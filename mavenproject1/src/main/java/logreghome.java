...
public class logreghome extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Logika sederhana untuk menangani login
        if (username.equals("admin") && password.equals("password")) {
            JOptionPane.showMessageDialog(this, "Login Berhasil!");
            // Di sini, Anda dapat membuka form lain atau melakukan tindakan setelah login berhasil.
        } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new logreghome().setVisible(true);
            }
        });
    }
